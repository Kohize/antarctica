...
/* harmony import */ var _modules_burger__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/burger */ "./js/modules/burger.js");
...
var burgerLink = document.querySelectorAll('.header__link');
var backgroundOverlay = document.querySelector('.overlay');
...
if (window.innerWidth <= 767 && mainNav && burgerButton && burgerLink && backgroundOverlay) {
  mainNav.classList.remove('header__nav--opened');
  mainNav.classList.add('header__nav--closed');
  burgerLink.forEach(function (element) {
